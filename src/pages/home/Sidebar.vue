    ...
    <div class="content-wrapper absolute top-0 right-0 bottom-0 left-0 overflow-visible z-10">
      <div class="sidebar-content w-60 flex flex-col transition-all duration-300 ease-in-out bg-neutral-50 dark:bg-zinc-800"
        ...
        <div class="w-full h-11 flex-shrink-0 flex items-center px-4 space-x-1">
          <i class="size-[32px] bg-[url('/logo.svg')] bg-contain bg-center"></i>
          <span class="font-bold">Vue Template</span>
          <div class="flex-1"></div>
          <ChevronsLeftIcon v-if="!isCollapsed"
            class="size-5 text-zinc-400 hover:text-zinc-700 dark:text-zinc-300 dark:hover:text-zinc-50 hover:cursor-pointer transition-opacity duration-300 ease-in-out"
