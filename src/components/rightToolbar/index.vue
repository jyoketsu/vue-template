	...
	<div class="top-right-btn" :style="style">
		<el-row>
			...
			<el-tooltip class="item" effect="dark"
				:content="showSearch ? $t('common.hideSearch') : $t('common.displayTheSearch')" placement="top" v-if="search">
				<el-button circle :icon="SearchIcon" @click="toggleSearch()" />
			</el-tooltip>

			<!-- 导出 -->
			<el-tooltip class="item" effect="dark" :content="$t('common.exportBtn')" placement="top" v-if="isExport()">
				<el-button circle :icon="DownloadIcon" @click="handleExport()" />
			</el-tooltip>

			<!-- 刷新功能 -->
			<el-tooltip class="item" effect="dark" :content="$t('common.refresh')" placement="top">
				<el-button circle :icon="RotateCcwIcon" @click="handleRefresh()" />
			</el-tooltip>
...
<script setup lang="ts" name="right-toolbar">
import { computed } from 'vue';
import { SearchIcon, RotateCcwIcon, DownloadIcon } from 'lucide-vue-next';
